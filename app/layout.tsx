...
export const metadata: Metadata = {
  ...
  description:
    'Your intelligent assistant for VinUniversity policies, information, and student services. Get instant answers about academic programs, campus life, and university resources.',
  keywords: [
    'VinUniversity',
    'VinUni',
    'chatbot',
